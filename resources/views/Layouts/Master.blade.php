                ...
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu" style="direction: rtl">
                            <ul>
                                <li class="current-list-item"><a href="/">الرئسية</a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('category') }}">الأقسام</a></li>
                                <li><a href="/addproduct">إضافة منتج</a></li>


                                <li><a href="/review">أراء العملاء</a></li>
                    ...
                    <div class="search-bar">
                        <div class="search-bar-tablecell">
                            ...
                            <form action="/search" method="POST">
                                <input type="text" name="search" placeholder="أدخل كلمة البحث">
                                @csrf()
